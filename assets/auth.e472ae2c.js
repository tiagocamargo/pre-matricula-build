import{h as s,u as n}from"./common.a40f3e2f.js";import{d as c,r as i,o as u,c as d,a as l,u as m}from"./vendor.5ec4ebb3.js";const g=()=>s.get("/auth/login",{withCredentials:!0}).then(e=>e.data),h=["innerHTML"],_=c({__name:"Login",setup(e){const a=m(),o=i("Logando.."),{loader:t}=n();return t(g).then(r=>{if(!r)throw new Error;a.push({name:"preregistrations"})}).catch(()=>{o.value=`
